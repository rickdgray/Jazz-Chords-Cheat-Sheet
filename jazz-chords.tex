...
\begin{tabular}{ p{3cm} p{1.1cm} p{3.15cm} p{1.55cm} p{4.25cm} p{1.6cm} p{1.9cm} }
    ...
    \hline
        ...
        \makecell[cc]{
            \raisebox{0ex}[5ex][1ex]{
                ...
                \Notes \zw{c}\zw{_e}\zw{g}\zw{_i}\en}}} &
        \makecell[cc]{
            \begin{tikzpicture}
    ...
    \hline
        ...
        \makecell[cc]{
            \raisebox{0ex}[5ex][1ex]{
                \musicintext{\staffbotmarg2\Interligne
                \Notes \zw{c}\zw{_e}\zw{_g}\zw{<i}\en}}} &
        \makecell[cc]{
            \begin{tikzpicture}
    ...
    \hline
        ...
        \makecell[cc]{
            \raisebox{0ex}[5ex][1ex]{
                \musicintext{\staffbotmarg2\Interligne
                \Notes \zw{c}\zw{_e}\zw{_g}\zw{_i}\en}}} &
        \makecell[cc]{
            \begin{tikzpicture}
    ...
    \hline
        ...
        \makecell[cc]{
            \raisebox{0ex}[5ex][1ex]{
                \musicintext{\staffbotmarg2\Interligne
                \Notes \zw{c}\zw{_e}\zw{g}\zw{_i}\zw{k}\en}}} &
        \makecell[cc]{
            \begin{tikzpicture}
    ...
    \hline
        \makecell[cl]{
            \textcolor{purple}{Dominant Ninth}} &
        \makecell[cl]{
            C\textsuperscript{9}} &
        \makecell[cl]{
            Major Ninth \\
